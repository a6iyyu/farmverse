    ...
    <figure className="relative h-100">
      ...
      <div className="z-10 flex h-100 w-full flex-col justify-between p-8 text-white">
        ...
        <figcaption className="cursor-default">
          <strong className="text-3xl">Jadilah Pejuang Agraria.</strong>
          <br />
        ...
        <Link href="/auth/login" className="flex w-fit items-center gap-2 rounded-md bg-white px-6 py-3 font-semibold text-black">
