...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-bl from-amber-900 to-amber-800 py-12">
      <div className="container mx-auto flex w-[90vw] flex-col items-center justify-between gap-12 lg:flex-row">
        <section className="mr-20 text-justify leading-7">
          <Image
            height={1000}
            width={1000}
            src="/ikon.png"
            ...
            loading="lazy"
          />
          <p className="mt-3 ml-3 cursor-default text-slate-200">
        ...
        <section className="flex justify-end space-x-20">
